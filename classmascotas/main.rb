...
clientes_sin_mascotas = GeneradorClientes.generar_sin_mascotas(99)
...
for i in 0..49
    clientes_sin_mascotas[i].mascota = lista_gatos[i]
end

for i in 50..99
    clientes_sin_mascotas[i].mascota = lista_perros[i - 50]
end

for cliente in clientes_sin_mascotas
...
for i in 0..100
    cliente = Cliente.new
    cliente.nombre_cliente = Faker::Name.name
    #asignación de mascota
    cliente.mascota = Mascota.new
    cliente.mascota.nombre = Faker::Creature::Animal.name
